...
<body id="body">
    ...
    <main>
        ...
        <summary class="registro">
            <form action="bd_estudiante/validar.php" method="post">
                <h1>Nuevo Estudiante</h1>
                <table class="tablereistre">
                    <tr>
                        <td><label for="doc">Cédula:</label></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="fecha" name="genero">
                    ...
                    <tr>
                        ...
                        <td><input class="fecha" type="text" id="edad" name="edad"></td>
                    </tr>
                    <tr>
                ...
                <button class="no" type="button" onclick="location.href='estudiantes.php';">Cancelar</button>
            </form>
