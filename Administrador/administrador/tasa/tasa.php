        ...
        <summary class="registro">
            <form>
                ...
                <table class="tablereistre">
                    <tr>
                        <td><label for="bankName">Valor:</label></td>
                    ...
                    <tr>
                        <td><label for="bankCode">Fecha:</label></td>
                        <td><input class="fecha" type="date" id="bankCode" name="bankCode"></td>
                    </tr>
                </table>
                <button class="si" type="submit" formaction="../administrador.html">Guardar</button>
                <button class="no" type="button" onclick="location.href='../administrador.html';">Cancelar</button>
            </form>
